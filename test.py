...
# Function to create date list based on start year, start month, and number of values
def generate_dates(start_year, start_month, num_values):
    dates = []
...
for index, row in original_df.iterrows():
    ...
    # Generate date list for original values
    dates = generate_dates(start_year, start_month, num_values)
